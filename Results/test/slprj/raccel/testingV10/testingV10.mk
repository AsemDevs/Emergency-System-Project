...
MODEL                = testingV10
MODULES              = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c testingV10.c testingV10_capi.c testingV10_data.c testingV10_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT              = testingV10.exe
MAKEFILE             = testingV10.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = E:/Semester10/EE402/PROJECT/Emergency System Project/Results/test
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = testingV10_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/testingV10 \
...
sfun_spid_contc.obj : C:\Program\ Files\Polyspace\R2020a\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2020a\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
